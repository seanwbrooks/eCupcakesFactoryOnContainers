namespace Api.KafkaUtil
{
    ...
    public class ProducerWrapper
    {
        ...
        public async Task writeMessage(string message){
            ...
            using (var producer = new ProducerBuilder<Null, string>(this._config).Build())
            {
              
                await producer.ProduceAsync(this._topicName, new Message<Null, string> { Value = message })
