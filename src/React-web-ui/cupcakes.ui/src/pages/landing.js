...
import { submitUserOrderRequest,submitMixedOrder,submitBakedOrder,
    submitDecoratedOrder,submitBoxedOrder,
    cupcakeFlavourChange,cupcakeSizeChange
} from "../actions";
        ...
        <div>
            <Grid container spacing={24} style={{padding: 24}}>
                <Grid item xs={12} sm={6} lg={4} xl={3}>
                    ...
                    FlavourChange={props.cupcakeflavourchange}  SizeChange={props.cupcakeSizechange}
                    Flavour={props.orderdetails.Flavour} Size ={props.orderdetails.Size} 
                    SubmitOrderCallback = {props.submitOrder}/>
                </Grid>
                <Grid item xs={12} sm={6} lg={4} xl={3}>
...
const mapDispatchToProps = dispatch => ({
    cupcakeflavourchange: payload => dispatch(cupcakeFlavourChange(payload)),
    cupcakeSizechange: payload => dispatch(cupcakeSizeChange(payload)),
